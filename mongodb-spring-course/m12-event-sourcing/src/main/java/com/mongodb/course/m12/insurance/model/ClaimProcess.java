package com.mongodb.course.m12.insurance.model;
...
public class ClaimProcess {
    ...
    public Map<String, Object> toSnapshot() {
        ...
        if (assessedAmount != null) state.put("assessedAmount", assessedAmount.toPlainString());
        if (approvedAmount != null) state.put("approvedAmount", approvedAmount.toPlainString());
        if (paidAmount != null) state.put("paidAmount", paidAmount.toPlainString());
    ...
    public static ClaimProcess fromSnapshot(Map<String, Object> state) {
        ...
        if (state.containsKey("assessedAmount"))
            process.assessedAmount = new BigDecimal((String) state.get("assessedAmount"));
        if (state.containsKey("approvedAmount"))
            process.approvedAmount = new BigDecimal((String) state.get("approvedAmount"));
        if (state.containsKey("paidAmount"))
            process.paidAmount = new BigDecimal((String) state.get("paidAmount"));
